# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-11-18 04:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombreResultadoEscaneado', models.TextField(max_length=100)),
                ('resultadoEscaneado', models.FileField(upload_to='Expediente/resultadosEscaneados')),
